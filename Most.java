...
public class Most {
    ...
    */
    ...
    public static void main(String[] args)
    {
        ...
        // create the hashtable to store names and their popularities
        Hashtable<String, Integer> names = new Hashtable<>();
        // create arraylist to store the names as well
        ...
        // calculate the misspellability of each name
        for(int i = 0; i < k; i++)
        {
            double sum = 0;
            ...
            // check names that we already know are similar
            ...
            double temp = (sum / names.get(curr))*100;
            int misspel = (int)Math.round(temp);

            misspellabilityAll.put(curr, misspel);
            
        }

        // now we have misspellabilityAll, a hashtable containing k names and missppellability scores
        // time to find the maximum values and print them
